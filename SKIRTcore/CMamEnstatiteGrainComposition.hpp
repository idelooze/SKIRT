...
/** The CMamEnstatiteGrainComposition class represents the optical properties of amorphous
    silicates with enstatite-normative composition from Kohler et al. 2014 (A&A, 565, L9),
    and, together with the amorphous silicates with forsterite-normative composition replace
