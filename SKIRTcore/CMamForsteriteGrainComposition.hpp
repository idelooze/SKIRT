...
/** The CMamForsteriteGrainComposition class represents the optical properties of amorphous
    silicates with forsterite-normative composition from Kohler et al. 2014 (A&A, 565, L9),
    and, together with the amorphous silicates with enstative-normative composition replace
    the silicate grains of Jones et al. 2013 (A&A, 558, A62)
    The calorimetric properties are calculated in DustEM. */
